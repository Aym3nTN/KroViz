...
async function getGithubStars() {
  try {
    const res = await fetch('https://api.github.com/repos/Aym3nTN/KroViz', {
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            >
              ...
              GitHub
              {stars !== null && (
                <span className="ml-1 px-2.5 py-0.5 bg-slate-100 text-slate-700 text-xs rounded-full font-bold shadow-sm border border-slate-200">
                  ★ {stars}
                </span>
              )}
            </a>
