...
export const SAMPLE_RGDS = [
  {
    ...
    file: '/KroViz/samples/web-app.yaml',
    resourceCount: 4,
  ...
  },
  {
    ...
    file: '/KroViz/samples/coredns.yaml',
    resourceCount: 3,
    complexity: 'simple' as const,
  },
  {
    ...
    file: '/KroViz/samples/wordpress.yaml',
    resourceCount: 8,
  ...
  },
  {
    ...
    file: '/KroViz/samples/multi-tenant.yaml',
    resourceCount: 10,
  ...
  },
  {
    ...
    file: '/KroViz/samples/complex-app.yaml',
    resourceCount: 14,
    complexity: 'complex' as const,
  },
] as const;
